 ...
 * El patrón Ejemplos.Singleton se implementa creando en nuestra clase un método que crea
 ...
 * de la aplicación.
 * El patrón Ejemplos.Singleton provee una única instancia global gracias a que:
...
public class DatabaseConnection
{
    ...
    public static java.sql.Connection getConnection(){
        ...
        if(con==null){
            try {
                String host = "jdbc:mysql://localhost:33060/mundialAngel";
                String username = "angelTest";
